...
class BoardHttpTest {
    ...
    @Test
    fun `add a card via http`() {
        s.test("add card http") { ctx ->
    ...
    @Test
    fun `new card starts in todo via http`() {
        s.test("default column http") { ctx ->
    ...
    @Test
    fun `move card via http`() {
        s.test("move card http") { ctx ->
    ...
    @Test
    fun `remove card via http`() {
        s.test("remove card http") { ctx ->
    ...
    @Test
    fun `query card by id via http`() {
        s.test("get card http") { ctx ->
    ...
    @Test
    fun `column count via http`() {
        s.test("column count http") { ctx ->
    ...
    @Test
    fun `multiple cards across columns via http`() {
        s.test("multi column http") { ctx ->
    ...
    @Test
    fun `trace records http operations`() {
        s.test("board trace http") { ctx ->
